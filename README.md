...
# Текущие проблемы:
- Под стандартными правами zabbix не отслеживаются все службы
```
#Не безопасный, но рабочий способ добавить учетку в Root
sudo usermod -aG sudo zabbix
```
